...
Current tested source: `253bc777ff0c8d40a671adda02ca76bc9275d456`. Dormant Web completion and the full business-store compatibility fence are **PASS_LOCAL**. Active Web storage/UI/sync integration, authoritative backup/recovery, native integration and mixed-version activation remain incomplete. Earlier sections retain their checkpoint-specific limitations; the latest section records current fence evidence.
