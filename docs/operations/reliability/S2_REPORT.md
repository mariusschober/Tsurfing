...
Current tested source: `f3fa120c106c14dfe58315c67e8f57c44a1fb41c`. Web completion admission, exact receipt retirement, bounded history download and atomic task/effect/focus application are **PASS_LOCAL** as dormant library paths. Active Web coordination and the business-store compatibility fence, native integration, and legacy/nonempty restore recovery remain. Earlier sections retain their checkpoint-specific limitations; the latest section records current completion application evidence.
